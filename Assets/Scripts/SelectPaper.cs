...
public class SelectPaper : MonoBehaviour {
	...
	public Material normalPaperM;
	public Material damagedPaperM;
				...
				if (Physics.Raycast (ray, out rayHit, maxRayDistance)) {
					if (rayHit.transform.GetComponent<Rigidbody> () != null) {
						...
						if (Random.Range (1, 100) < 10) {
							newPaper.GetComponent<Renderer> ().material = damagedPaperM;
						} else {
							newPaper.GetComponent<Renderer> ().material = normalPaperM;
						}
